 ...
 */
final class Version20190213172148 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sessions (id VARCHAR(255) NOT NULL, questionnaire_id INT NOT NULL, email VARCHAR(255) DEFAULT NULL, is_done TINYINT(1) DEFAULT NULL, INDEX IDX_9A609D13CE07E8FF (questionnaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ue (id INT AUTO_INCREMENT NOT NULL, questionnaire_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, has_tdtp TINYINT(1) DEFAULT NULL, INDEX IDX_2E490A9BCE07E8FF (questionnaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
